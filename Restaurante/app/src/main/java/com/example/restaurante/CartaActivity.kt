...
class CartaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val productos = mapOf(
            R.id.sushi1 to 5.0, R.id.sushi2 to 6.0, R.id.sushi3 to 4.5, R.id.sushi4 to 7.0, R.id.sushi5 to 5.5,
            R.id.sushi6 to 6.5, R.id.sushi7 to 8.0, R.id.sushi8 to 7.5, R.id.poke1 to 9.0, R.id.poke2 to 10.0,
            R.id.poke3 to 8.5, R.id.poke4 to 11.0, R.id.poke5 to 9.5, R.id.poke6 to 10.5, R.id.poke7 to 12.0,
            R.id.poke8 to 11.5, R.id.especial1 to 13.0, R.id.especial2 to 14.0, R.id.especial3 to 12.5,
            R.id.especial4 to 15.0, R.id.especial5 to 14.5, R.id.especial6 to 16.0
        )
